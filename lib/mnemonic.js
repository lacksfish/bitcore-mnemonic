 ...
 * @returns {Buffer}
 */
Mnemonic.prototype.toSeed = function(passphrase, rounds) {
  if ((Math.log(rounds)/Math.log(2)) % 1 !== 0) {
    throw bitcore.errors.InvalidArgument('ENT', 'Values must be power of 2')
  }
  passphrase = passphrase || '';
  return pbkdf2(unorm.nfkd(this.phrase), unorm.nfkd('mnemonic' + passphrase), rounds, 64);
};
